    ...
    <Box
      ...
      >
        <div className="container mx-auto px-6">
          <h4 className="py-6">Example Page</h4>
        </div>
      </Box>
      <div className="px-6 pb-24 container mx-auto">
        <h4>Content</h4>
        <br />
        <div>
          <img
            src="morain-lake.jpg"
            alt="beach"
            className=" rounded-lg max-w-[640px] w-full"
          />
          <h1 className="py-4 font-semibold text-2xl">Early Sunrise</h1>
          ...
          <p className="text-sm">
            ...
            window at the dull weather. Drops of rain could be heard hitting the
          ...
          <p className="text-sm">
            ...
            cold shudder. He slid back into his former position.
          </p>
          <p className="text-sm">
            "Getting up early all the time", he thought, "it makes you stupid.
            You've got to get enough sleep. Other travelling salesmen live a
            life of luxury. For instance, whenever I go back to the guest house
            during the morning to copy out the contract, these gentlemen are
            always still sitting there eating their breakfasts. I ought to just
            try that with my boss; I'd get kicked out on the spot. But who
            knows, maybe that would be the best thing for me...
          </p>
          <p className="text-sm">
            His room, a proper human room although a little too small, lay
            peacefully between its four familiar walls. A collection of textile
